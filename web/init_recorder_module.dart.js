...
return s},
fD(){var s,r
try{s=v.G.RecorderModule.Asyncify
...
f=v.G
s=f.RecorderModule==null?6:8
break
case 6:if(!J.d_(f.self.flutter_recorder_force_single_threaded,!0)){e=f.globalThis.crossOriginIsolated
d=(e==null?!1:e)&&f.globalThis.SharedArrayBuffer!=null}else d=!1
o=d
n=o?"mt":"st"
f.self.flutter_recorder_build=n
f.self.flutter_recorder_has_asyncify=o
m="flutter_recorder: loading "+A.l(n)+" WASM build (crossOriginIsolated: "+A.l(f.globalThis.crossOriginIsolated)+")"
A.cw(m)
f.console.log(m)
s=9
return A.du(A.fu("assets/packages/flutter_recorder/web//libflutter_recorder_plugin"+(o?"_mt":"")+".js"),$async$br)
case 9:if(f.RecorderModule==null){f=A.cI("RecorderModule not found after loading the glue.")
throw A.f(f)}s=7
break
case 8:f.self.flutter_recorder_build="manual"
f.self.flutter_recorder_has_asyncify=A.fD()
A.cw(u.n)
f.console.log(u.n)
case 7:e=t.X
...
i=A.aa(a)
h=A.W(a)
g="flutter_recorder: Failed to initialize RecorderModule: "+A.l(i)+"\n"+A.l(h)
A.cw(g)
f=v.G.console
f.error(g)
throw a
...
h2(){v.G.self.flutter_recorder_ready=A.eg(A.br())},
...
A.cs.prototype={
$2(a,b){var s=a
return"assets/packages/flutter_recorder/web/"+A.l(s)},
...
var u={c:"Error handler must accept one Object or one Object and a StackTrace as arguments, and return a value of the returned future's type",o:"flutter_recorder: RecorderModule initialized and set globally.",n:"flutter_recorder: loading manual WASM build"}
