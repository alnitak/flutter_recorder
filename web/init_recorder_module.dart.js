...
bP(){var s=0,r=A.cT(t.m),q,p=2,o,n,m,l,k,j,i
var $async$bP=A.cX(function(a,b){if(a===1){o=b
s=p}while(true)switch(s){case 0:p=4
k=self
n=k.RecorderModule()
s=7
return A.cI(A.eT(n,t.m),$async$bP)
case 7:m=b
k.self.RecorderModule=m
A.d6("RecorderModule initialized and set globally.")
q=m
s=1
break
p=2
...
i=o
l=A.J(i)
A.d6("Failed to initialize RecorderModule: "+A.v(l))
throw i
s=6
break
case 3:s=2
