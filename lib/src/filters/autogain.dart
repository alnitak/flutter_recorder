...
class AutoGain extends _AutoGainInternal {
  ...
  FilterMetric get currentGain =>
      FilterMetric(filterType, AutoGainEnum.currentGain.index);

  FilterMetric get inputRms =>
      FilterMetric(filterType, AutoGainEnum.inputRms.index);

  FilterMetric get outputPeak =>
      FilterMetric(filterType, AutoGainEnum.outputPeak.index);

  FilterMetric get limiterClipCount =>
      FilterMetric(filterType, AutoGainEnum.limiterClipCount.index);

  FilterMetric get totalLimiterClipCount =>
      FilterMetric(filterType, AutoGainEnum.totalLimiterClipCount.index);

  FilterMetric get lastFrameCount =>
      FilterMetric(filterType, AutoGainEnum.lastFrameCount.index);
}
