...
@ffi.Native<ffi.Void Function(dartDeviceNotificationCallback_t)>()
external void flutter_recorder_setDartDeviceNotificationCallback(
  dartDeviceNotificationCallback_t callback,
);

@ffi.Native<ffi.Void Function(dartDeviceNotificationCallback_t, ffi.Int64)>()
external void flutter_recorder_setDartDeviceNotificationCallbackForEngine(
  dartDeviceNotificationCallback_t callback,
  int engine_id,
);
...
typedef dartDeviceNotificationCallback_tFunction =
    ffi.Void Function(ffi.Int eventType);
typedef DartdartDeviceNotificationCallback_tFunction =
    void Function(int eventType);
typedef dartDeviceNotificationCallback_t =
    ffi.Pointer<ffi.NativeFunction<dartDeviceNotificationCallback_tFunction>>;
